...
from app.db.base import ENV_SCHEMA, ML_SCHEMA, ROUTING_SCHEMA, SEAICE_SCHEMA, TRACKING_SCHEMA, Base
...
MANAGED_SCHEMAS = {TRACKING_SCHEMA, ML_SCHEMA, ENV_SCHEMA, SEAICE_SCHEMA, ROUTING_SCHEMA}
